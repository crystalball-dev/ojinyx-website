...
- Every release now has an animated cover, and no release carries a `cover` override. If one ever needs a still instead, set `cover` on it and the generated poster steps aside.
